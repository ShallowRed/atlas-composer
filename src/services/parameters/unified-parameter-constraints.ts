 ...
 * These maintain the existing API while delegating to the unified system
 */
 ...
 */
export function getParameterConstraints(family: ProjectionFamilyType): ProjectionFamilyConstraints {
...
export function isParameterRelevant(
  ...
  return UnifiedParameterConstraints.isParameterRelevant(family, parameter)
}

/**
 * Get default value for a parameter
 * @deprecated Use UnifiedParameterConstraints.getParameterDefault() instead
 */
export function getParameterDefault(
  family: ProjectionFamilyType,
  parameter: keyof BaseProjectionParameters,
): unknown {
  return UnifiedParameterConstraints.getParameterDefault(family, parameter)
}
...
export function validateParameterValue(
  ...
  return UnifiedParameterConstraints.validateParameter(family, parameter, value)
}
